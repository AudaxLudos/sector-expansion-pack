...
public class CohesiveFormation extends SCBaseSkillPlugin {
    ...
    public void addTooltip(SCData data, TooltipMakerAPI tooltip) {
        ...
        tooltip.addPara("%s (Max: %s) fleet acceleration", 0f, Misc.getHighlightColor(), Misc.getHighlightColor(), "+" + Math.round(ACCELERATION_MULT * bonusMult * penaltyMult * 100f) + "%", Math.round(ACCELERATION_MULT * bonusMult * 100f) + "%");
    }
